"""Claude Remote MCP Server - Proxy command operations to remote cluster via SSH.
...
Configuration via environment variables:
  ...
  REMOTE_PROJECT_DIR='/personal/code/my_project'
  REMOTE_AGENT_PATH='/shared/storage/.mcp-agent/agent.py'

Legacy single-node mode (backward compatible):
  SSH_CMD='ssh -p 10023 127.0.0.1'
"""
...
# Path to agent.py on shared storage (accessible from all containers)
REMOTE_AGENT_PATH = os.environ.get("REMOTE_AGENT_PATH", "/personal/.mcp-agent/agent.py")
