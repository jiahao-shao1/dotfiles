...
Cross-machine config sync for Claude Code, Zsh, Tmux, Starship, Ghostty, and iTerm2 — powered by [GNU Stow](https://www.gnu.org/software/stow/).
...
跨机器同步 Claude Code、Zsh、Tmux、Starship、Ghostty 和 iTerm2 配置 — 基于 [GNU Stow](https://www.gnu.org/software/stow/)。
